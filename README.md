...
- 확정된 약관 안에서만 동작하는 낱말·의미 검색 결합
- 규칙 판정 뒤에만 실행되는 구조화 LLM 설명
- 근거 조항·쪽수·인용문 검증
- 승인된 자기부담금·장해지급률 사실의 보수적 조회
...
자기부담금 승인 원장과 장해지급률 후보도 약관 문구가 포함돼 있어 공개본에는 없습니다.
장해지급률 후보는 사람이 원문을 승인하기 전까지 서비스와 인용에 사용되지 않습니다.
